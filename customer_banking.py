...
def main():
    ...
    savings_maturity = float(input("Enter length of months for the savings account: "))
    ...
    # ADD YOUR CODE HERE
    print('The updated savings account balance with interest earned is $', format(updated_savings_balance, ',.2f'))

    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    # ADD YOUR CODE HERE
    cd_balance = float(input("Enter the cd account balance? "))
    cd_interest = float(input("Enter the interest rate for the cd account? "))
    cd_maturity = int(input("Enter length of months for the cd account: "))
